...
Typically when you get asked to review something by your team members, you should acknowledge the request within 1 business day. Acknowledging a review request can be sending a quick direct message to the author in your organisations' communication app, leaving a comment on the pull request, leaving a review, _or_ in some cases, rejecting the review request altogether.
